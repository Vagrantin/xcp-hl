...
>
> **XCP-ng HomeLab Edition est en version alpha.** Le projet est en cours de
...
## Qu'est-ce que XCP-ng HomeLab Edition ?
...
**XCP-ng HL** garde tout ce qui fait la force de XCP-ng, mais remplace ce
...
chaque évolution en amont. XO Lite HL est construit à partir d'un tag amont
...
qu'une évolution en amont ne puisse jamais casser un déploiement existant.
...
{: .note }
Toutes les ISO et tous les RPM publiés sont signés avec la **clé GPG XCP-ng
HomeLab Edition**. Vérifiez votre téléchargement avant l'installation.
...
| Empreinte | `2F59 1DB9 D2C1 28C4 C3D9  63F4 6DA0 0DCA 5BBA 215A` |
...
# Vérifier la signature du fichier de somme de contrôle de l'ISO
# (les fichiers de somme de contrôle portent le nom de l'ISO — exemple pour v8.3-ce9)
...
XCP-ng HL est publié sous **licence publique générale GNU Affero v3.0**
(AGPL-3.0). Il s'appuie sur XCP-ng en amont (composants Apache 2.0 / GPL) et
sur Xen Orchestra (AGPL-3.0).

> XCP-ng Home lab Edition est un projet communautaire indépendant.
