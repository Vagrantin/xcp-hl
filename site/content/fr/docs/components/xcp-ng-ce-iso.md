...
[`xolite-ce`](/docs/components/xolite-ce) et le RPM signé `xoa-proxy` produit par
[`xoa-proxy`](/docs/components/xoa-proxy), les superpose à une base XCP-ng 8.3 standard à
...
### Modification de host-installer pour la partition de stockage ISO {#host-installer-patching}
