...
trouvent dans la [matrice des versions](/docs/reference/release-matrix).
{class="lead"}
...
La [matrice des versions](/docs/reference/release-matrix) ne consignait qu'un tag de
...
[matrice des versions](/docs/reference/release-matrix#xoa-hl-releases) fait le lien entre
...
La [matrice des versions](/docs/reference/release-matrix) comporte désormais un tableau
