...
プロキシが展開する XOA イメージは [`xoa-hl`](https://github.com/Vagrantin/xoa-hl) です。
XCP-hl 向けにソースからビルドした Xen Orchestra で、ライセンスが必要な
メニュー項目や督促バナーを取り除いています。ビルド方法は
[コンポーネント](/docs/components/xoa-hl)を参照してください。
